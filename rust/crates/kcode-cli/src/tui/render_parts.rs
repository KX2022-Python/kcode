...
pub(super) fn palette(theme: ThemePreset) -> Palette {
    match theme {
        ...
        ThemePreset::Sunset => Palette {
            accent: Color::Rgb(255, 133, 92),
            accent_alt: Color::Rgb(255, 210, 167),
            accent_soft: Color::Rgb(171, 88, 64),
            border: Color::Rgb(108, 59, 42),
            border_active: Color::Rgb(255, 133, 92),
            surface: Color::Rgb(38, 20, 18),
            panel: Color::Rgb(30, 16, 14),
            panel_alt: Color::Rgb(55, 29, 24),
            muted: Color::Rgb(164, 128, 118),
            success: Color::Rgb(126, 219, 171),
            warning: Color::Rgb(255, 201, 95),
            text: Color::Rgb(255, 240, 232),
            text_dim: Color::Rgb(211, 183, 171),
        },
